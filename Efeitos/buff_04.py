...
class SpritesEfeito4(pygame.sprite.Sprite):  # classe para efeito especiail 4 (velocidade de disparo)
    def __init__(self):
   
        pygame.sprite.Sprite.__init__(self)

        # defina a imagem que vai ser exibida
        self.image = sprite_sheet_efeitos.subsurface((320 * 1, 320 * 0), (320, 320))
    ...
    def buff(self):
        ...
        if arquivo_upgrade.iloc[3, 0] == True:
            Variaveis_globais.tempo_buff_velocidade_disparo = 600
        else:
            Variaveis_globais.tempo_buff_velocidade_disparo = 300
